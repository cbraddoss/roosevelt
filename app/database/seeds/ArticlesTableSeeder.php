...
class ArticlesTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		Article::create(array(
			...
			'edit_id' => '2',
			'status' => 'published',
			'created_at' => '2014-10-16 21:22:48'
		));
		...
		Article::create(array(
			...
			'edit_id' => '3',
			'status' => 'published',
			'created_at' => '2014-10-10 21:22:48'
		));
		...
		Article::create(array(
			...
			'edit_id' => '4',
			'status' => 'published',
			'created_at' => '2014-10-01 21:22:48'
		));
...
",
			...
			'edit_id' => '2',
			'status' => 'published',
			'created_at' => '2014-10-06 11:22:48'
		));
...
stuck on shorecrest in raven",
			...
			'created_at' => '2014-10-17 12:42:48'
		));
...
I'll be getting inndx and directory updated here in a few minutes.",
			...
			'edit_id' => '1',
			'status' => 'published',
			'created_at' => '2014-10-12 14:22:48'
		));
	}
}