				...
				<div id="menu_header">
					<div class="menu_nav">
						<ul id="menu_links">
							...
							<li alt="Projects" id="link-projects" class="link"><a href="/projects" class="ss-list">Projects</a><span class="ss-chat"></span><span class="linked-to">5</span></li>
							<li alt="Billable Updates" id="link-billables" class="link"><a href="/billables" class="ss-flag">Billables</a><span class="ss-chat"></span><span class="linked-to">3</span></li>
							...
							<li alt="Calendar" id="link-calendar" class="link"><a href="/calendar" class="ss-calendar">Calendar</a><span class="ss-chat"></span><span class="linked-to">10</span></li>
							<li alt="Internal Help" id="link-help" class="link"><a href="/help" class="ss-help">Help</a><span class="ss-chat"></span><span class="linked-to">7</span></li>
							<li alt="News" id="link-news" class="link"><a href="/news" class="ss-newspaper">News</a><span class="ss-chat"></span><span class="linked-to">4</span></li>
