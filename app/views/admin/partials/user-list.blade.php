<td class="user-name" fieldvalfirst="{{ $u->first_name }}" fieldvallast="{{ $u->last_name }}"><div>{{ $u->first_name }} {{ $u->last_name }} <small class="last-login">@if($u->last_login != '0000-00-00 00:00:00') Last Login: {{ str_limit($u->last_login,10,'') }} @endif</small></div></td>
