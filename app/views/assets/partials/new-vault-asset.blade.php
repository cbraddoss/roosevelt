...
<div class="new-form-field">
{{ Form::label('url', 'URL:') }}
{{ Form::text('url', null, array('placeholder' => 'URL', 'class' => 'vault-url field')) }}
</div>

<div class="new-form-field">
{{ Form::label('username', 'Username:') }}
{{ Form::text('username', null, array('placeholder' => 'Username', 'class' => 'vault-username field')) }}
</div>

<div class="new-form-field">
{{ Form::label('password', 'Password:') }}
{{ Form::text('password', null, array('placeholder' => 'Password', 'class' => 'vault-password field')) }}
</div>

<div class="new-form-field">
{{ Form::label('database_name', 'Database:') }}
{{ Form::text('database_name', null, array('placeholder' => 'Database Name', 'class' => 'vault-database-name field')) }}
</div>

<div class="new-form-field">
{{ Form::label('ftp_path', 'FTP Path:') }}
{{ Form::text('ftp_path', null, array('placeholder' => 'FTP Path (if needed)', 'class' => 'vault-ftp-path field')) }}
</div>

<div class="new-form-field">
{{ Form::label('notes', 'Notes:') }}
{{ Form::textarea('notes', null, array('placeholder' => 'Add additional notes here.', 'class' => 'vault-notes field')) }}
</div>
