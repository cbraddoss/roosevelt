...
{{ Form::text('show_on_calendar', Carbon::createFromFormat('Y-m-d H:i:s', $article->show_on_calendar)->format('m/d/Y'), array('placeholder' => 'Post to Calendar', 'class' => 'future-dates datepicker article-calendar-date field', 'data-date-format' => 'mm/dd/yyyy', 'data-date-viewmode' => 'days')) }}
@else
{{ Form::text('show_on_calendar', null, array('placeholder' => 'Post to Calendar', 'class' => 'future-dates datepicker article-calendar-date field', 'data-date-format' => 'mm/dd/yyyy', 'data-date-viewmode' => 'days')) }}
@endif
</div>
